...
export default function TopBar() {
	...
	return (
		<div className="flex items-center justify-end gap-4 border-b border-gray-300 bg-gray-200 p-2 dark:border-hatai-600 dark:bg-hatai-800">
				...
				<AnimatePresence>
					{isOpen && (
						<motion.ul
							...
							className="absolute z-50 overflow-hidden rounded-md border border-gray-400 text-center ltr:right-0 rtl:left-0 dark:border-hatai-600">
							<li
								onClick={() => {
							...
							<li onClick={() => {i18n.changeLanguage("ar"); setIsOpen(false)}}>
